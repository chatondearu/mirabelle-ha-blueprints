const n=`blueprint:
  ...
  name: "[CDA] 💡 Presence Based Lighting"
  description: "Automatically control lights based on presence detection"
  domain: automation
  source_url: https://github.com/chatondearu/mirabelle-ha-blueprints/blob/main/blueprints/automations/presence_based_lighting.yaml
  input:
    presence_sensor:
  ...
  - choose:
    ...
    default:
      - service: light.turn_off
        target:
          entity_id: !input light_entity `;export{n as default};
//# sourceMappingURL=presence_based_lighting-CQenQero.js.map
