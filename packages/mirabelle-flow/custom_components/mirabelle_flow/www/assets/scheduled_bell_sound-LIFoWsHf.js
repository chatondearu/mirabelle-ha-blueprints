const n=`blueprint:
  ...
  name: '[CDA] 🔔 Scheduled Bell Sound'
  description: 'Play a sound at specific times with volume control'
  domain: automation
  source_url: https://github.com/chatondearu/mirabelle-ha-blueprints/blob/main/blueprints/automations/scheduled_bell_sound.yaml
  input:
    player_input:
      name: 'Player'
...
//# sourceMappingURL=scheduled_bell_sound-LIFoWsHf.js.map
