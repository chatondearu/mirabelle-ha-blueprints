...
AUTOMATION_INPUTS: dict[str, dict[str, Any]] = {
    ...
    "garden-zone-irrigation.yaml": {
        "zone_id": "soil_test",
        "irrigation_type": "soil",
        "zone_enabled_helper": "input_boolean.test_zone_enabled",
        "valve_switch": "switch.test_valve",
        "volume_sensor": "sensor.test_volume",
        "target_volume_helper": "input_number.test_garden_volume",
        "max_duration_helper": "input_number.test_garden_duration",
        "on_time_number": "",
        "retry_attempts": 3,
        "retry_delay_seconds": 45,
        "force_close_on_pause": True,
        "pause_helper": "input_boolean.test_garden_pause",
        "master_enable_helper": "input_boolean.test_garden_enable",
        "notify_service": "",
    },
...
AUTOMATION_INPUTS_HEAVY: dict[str, dict[str, Any]] = {
    ...
    "garden-irrigation-orchestrator.yaml": {
        ...
        "pause_helper": "input_boolean.test_garden_pause",
        "rain_sensor": "",
        "rain_lookback_hours": 0,
        "run_mode_helper": "input_select.test_garden_run_mode",
        "zone_wait_timeout_minutes": 90,
        "heat_aerial_priority": True,
        "aerial_zone_ids": "aerial_test",
        "aerial_time_triggers": ["input_datetime.test_garden_slot"],
        "outdoor_temperature": "sensor.test_outdoor_temp",
        "aerial_temp_threshold_helper": "input_number.test_garden_temp_threshold",
        "heat_cooldown_helper": "input_number.test_garden_cooldown",
        "last_heat_helper": "input_datetime.test_garden_last_heat",
        "soil_zone_ids": "soil_test",
        "soil_time_triggers": ["input_datetime.test_garden_slot"],
    },
}
...
def frient_keypad_inputs(device_id: str) -> dict[str, Any]:
    """Inputs for the Frient keypad fallback blueprint (CDA Alarm target panel)."""
    return {
        "keypad": device_id,
